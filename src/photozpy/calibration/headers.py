...
class HeaderCorrection:
    ...
    def correct_filter_headers(
        ...
        **filter_dict,
        ...
        fl_collection = ImageFileCollection(
        ...
        for i in tqdm(fits_files):
            ...
            if "Bias" in fits_path.stem or "bias" in fits_path.stem or type == "Bias":
                header_dict = {
                    "IMTYPE": ("Bias", None),
                    "GAIN": (
                        self._telescope.ccd_gain.value,
                        self._telescope.ccd_gain.unit.to_string(),
                    ),
                    "RDNOISE": (
                        self._telescope.ccd_rdnoise.value,
                        self._telescope.ccd_rdnoise.unit.to_string(),
                    ),
                    "OBJECT": ("Bias", None),
                ...
                _ = HeaderManipulation.correct_headers(
                    one_image_collection,
...
class HeaderManipulation:
    ...
    def check_headers(image_collection, **headers_values):
        ...
        for header, value in headers_values.items():
            ...
            values_in_collection = [
                *set(values_in_collection)
