...
class mImageFileCollection:
    ...
    def __init__(
        ...
        if self.ncollection == 1:
            self.mcollection = ImageFileCollection(
                location=self.image_dir[0],
                keywords=keywords,
            ...
            for i in self.image_dir:
                ...
                _mcollection = ImageFileCollection(
                    location=i,
                    keywords=keywords,
                    find_fits_by_reading=find_fits_by_reading,
                    filenames=filenames,
    ...
    def refresh_collections(self, index=None):
        ...
        for i in index:
            self.mcollection[i] = ImageFileCollection(
                location=self.image_dir[i],
